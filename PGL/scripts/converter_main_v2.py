...
def varInitialization(fh, typ, cl_type, cl_argName, N):
    ...
    if (cl_type == "int" or \
        ...
        vecInit(fh, cl_argName, N, cl_type, [5.0, 5.0, 5.0], typ)
    else:
...
# npb-3_3-LU-ssor3
    ...
    if (
        ...
        clFile != "npb-3.3-SP-exact_rhs1.cl" and
        clFile != "npb-3.3-BT-initialize1.cl" and 
        clFile != "npb-3.3-SP-compute_rhs6.cl" and 
        clFile != "npb-3.3-SP-exact_rhs5.cl" and
        clFile != "npb-3.3-BT-exact_rhs5.cl" and 
        clFile != "npb-3.3-BT-compute_rhs6.cl" and 
        clFile != "npb-3.3-SP-compute_rhs6.cl" and 
        clFile != "npb-3.3-LU-ssor2.cl" and 
        clFile != "npb-3.3-SP-initialize1.cl" and 
        clFile != "npb-3.3-BT-compute_rhs2.cl" and
        clFile != "npb-3.3-SP-compute_rhs2.cl" and 
        clFile != "npb-3.3-SP-add.cl" and 
        #clFile != "npb-3.3-BT-z_solve2.cl" and
        #clFile != "npb-3.3-BT-x_solve2.cl" and
        #clFile != "npb-3.3-BT-y_solve2.cl" and 
        clFile != "npb-3.3-BT-add.cl" and
        clFile != "npb-3.3-LU-ssor3.cl"
       ):
        continue
    '''
    #print clFile
    ...
    for line in fr:
        ...
        if (re.search(r'get\_global\_id', line)):
            ...
            #print var
            if (var != '='):
                #cString = "for (int {} = 0; {} < {}; {}++)".format(var, var, int(N/16), var)+" {\n"
                cString = "int {} = 0;\n".format(var)
            else:
                var = lst[2]
                #cString = "for ({} = 0; {} < {}; {}++)".format(var, var, int(N/16), var)+" {\n"
                cString = "{} = 0;\n".format(var)
            parenthesis += 1
            #print cString
            fwC.write(cString)
            ...
            if (var == ''):
                ...
                var1 = lst[3]
                #print var
                #cString = "for (int {} = 0; {} < {}; {}++)".format(var1, var1, int(N/16), var1)+" {\n"
                cString = "int {} = 0;\n".format(var1)
                parenthesis += 1
                #print cString
                fwC.write(cString)
...
# amd-app-sdk-3_0-MatrixMultiplication-mmmKernel
# parboil-0_2-lbm-performStreamCollide_kernel
# shoc-1_1_5-S3D-ratxb_kernel
# segmentation fault:
# rodinia-3_1-pathfinder-dynproc_kernel
# npb-3_3-BT-compute_rhs5
# npb-3_3-SP-compute_rhs5
...
# stop at counter 188
    if ( 
        ...
        filename == "npb-3_3-BT-error_norm" or \
...
print "Congrats! counter = {}".format(counter)
fwriteAMD.close() 
fwriteNVD.close()
