...
def polybench_gpu_1_0_correlation_mean_kernel():
	...
	NXG.add_edge(134, 16, weight=1)
	NXG.add_edge(135, 10, weight=1)
	NXG.add_edge(136, 8, weight=1)
	NXG.add_edge(137, 14, weight=1)
	NXG.add_edge(138, 12, weight=1)
	NXG.add_edge(139, 78, weight=1)
	NXG.add_edge(140, 46, weight=1)
	NXG.add_edge(141, 18, weight=1)
