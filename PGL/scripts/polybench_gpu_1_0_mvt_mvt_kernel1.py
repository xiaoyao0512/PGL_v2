...
def polybench_gpu_1_0_mvt_mvt_kernel1():
	...
	NXG.add_edge(103, 13, weight=1)
	NXG.add_edge(104, 9, weight=1)
	NXG.add_edge(105, 11, weight=1)
	NXG.add_edge(106, 7, weight=1)
	NXG.add_edge(107, 52, weight=1)
	NXG.add_edge(108, 1, weight=1)
	NXG.add_edge(108, 2, weight=1)
	NXG.add_edge(108, 3, weight=1)
	NXG.add_edge(108, 4, weight=1)
	NXG.add_edge(108, 5, weight=1)
	NXG.add_edge(108, 6, weight=1)
	NXG.add_edge(108, 95, weight=1)
	NXG.add_edge(109, 15, weight=1)
	NXG.add_edge(109, 26, weight=1)
