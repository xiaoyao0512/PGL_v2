	...
	store  i32 %18, i32* %i, align 8
	  ...
	  %247 = getelementptr inbounds [13 x [5 x double]], [13 x [5 x double]]* %246, i64 0, i64 %238
	  ...
	  %231 = getelementptr inbounds [13 x [5 x double]], [13 x [5 x double]]* %230, i64 0, i64 %222
	  ...
	  %218 = getelementptr inbounds [13 x [5 x double]], [13 x [5 x double]]* %217, i64 0, i64 %209
	  ...
	  %203 = getelementptr inbounds [13 x [5 x double]], [13 x [5 x double]]* %202, i64 0, i64 %194
	  ...
	  %190 = getelementptr inbounds [13 x [5 x double]], [13 x [5 x double]]* %189, i64 0, i64 %181
	  ...
	  %176 = getelementptr inbounds [13 x [5 x double]], [13 x [5 x double]]* %175, i64 0, i64 %167
	  ...
	  %163 = getelementptr inbounds [13 x [5 x double]], [13 x [5 x double]]* %162, i64 0, i64 %154
	  ...
	  %150 = getelementptr inbounds [13 x [5 x double]], [13 x [5 x double]]* %149, i64 0, i64 %141
