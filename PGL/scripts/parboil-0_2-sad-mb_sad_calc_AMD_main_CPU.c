...
int i;
const int LIST_SIZE = 17845344;
short* a = (short*) malloc(sizeof(short) * LIST_SIZE);
for (int aaa = 0; aaa < LIST_SIZE; aaa++) {
	a[aaa] = 5;
}

short* b = (short*) malloc(sizeof(short) * LIST_SIZE);
...
fp = fopen("parboil-0.2-sad-mb_sad_calc.cl", "r");
if (!fp) {
...
ret = clEnqueueWriteBuffer(command_queue, a_mem_obj, CL_TRUE, 0,
	LIST_SIZE * sizeof(short), a, 0, NULL, NULL);
ret = clEnqueueWriteBuffer(command_queue, b_mem_obj, CL_TRUE, 0,
	LIST_SIZE * sizeof(short), b, 0, NULL, NULL);
