...
import dgl
def polybench_gpu_1_0_2mm_mm2_kernel1():
	NXG = nx.DiGraph()
	NXG.add_node(0, w=1)
	NXG.add_node(1, w=1)
	NXG.add_node(2, w=1)
	...
	NXG.add_edge(5, 84, weight=1)
	NXG.add_edge(5, 110, weight=1)
	NXG.add_edge(6, 7, weight=1)
	NXG.add_edge(6, 21, weight=1)
	NXG.add_edge(6, 50, weight=1)
	...
	NXG.add_edge(142, 47, weight=1)
	NXG.add_edge(143, 144, weight=1)
	NXG.add_edge(144, 0, weight=1)
	NXG.add_edge(145, 14, weight=1)
	NXG.add_edge(146, 12, weight=1)
	NXG.add_edge(147, 20, weight=1)
	NXG.add_edge(148, 16, weight=1)
	NXG.add_edge(149, 18, weight=1)
	NXG.add_edge(150, 10, weight=1)
	NXG.add_edge(151, 22, weight=1)
	NXG.add_edge(151, 24, weight=1)
	NXG.add_edge(151, 44, weight=1)
	NXG.add_edge(152, 70, weight=1)
	NXG.add_edge(152, 93, weight=1)
	NXG.add_edge(152, 119, weight=1)
	NXG.add_edge(153, 1, weight=1)
	NXG.add_edge(153, 2, weight=1)
	NXG.add_edge(153, 3, weight=1)
	NXG.add_edge(153, 4, weight=1)
	NXG.add_edge(153, 5, weight=1)
	NXG.add_edge(153, 6, weight=1)
	NXG.add_edge(153, 7, weight=1)
	NXG.add_edge(153, 8, weight=1)
	NXG.add_edge(153, 9, weight=1)
	NXG.add_edge(153, 137, weight=1)
