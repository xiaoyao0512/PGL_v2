	...
	store  i32 %7, i32* %d, align 8
	  ...
	  %117 = getelementptr inbounds [5 x double], [5 x double]* %116, i64 0, i64 1
	  %116 = getelementptr inbounds [13 x [5 x double]], [13 x [5 x double]]* %115, i64 0, i64 %108
	  %115 = getelementptr inbounds [13 x [13 x [5 x double]]], [13 x [13 x [5 x double]]]* %114, i64 0, i64 %110
	  %114 = getelementptr inbounds [13 x [13 x [5 x double]]], [13 x [13 x [5 x double]]]* %113, i64 %112
	  %113 = load [13 x [13 x [5 x double]]]*, [13 x [13 x [5 x double]]]** %o, align 8
	  %111 = load i32, i32* %g, align 4
	  %109 = load i32, i32* %f, align 4
	  %107 = load i32, i32* %e, align 4
	  %106 = load double, double* %h, align 8
	  %105 = getelementptr inbounds [5 x double], [5 x double]* %104, i64 0, i64 0
	  %104 = getelementptr inbounds [13 x [5 x double]], [13 x [5 x double]]* %103, i64 0, i64 %96
	  %103 = getelementptr inbounds [13 x [13 x [5 x double]]], [13 x [13 x [5 x double]]]* %102, i64 0, i64 %98
	  %102 = getelementptr inbounds [13 x [13 x [5 x double]]], [13 x [13 x [5 x double]]]* %101, i64 %100
	  %101 = load [13 x [13 x [5 x double]]]*, [13 x [13 x [5 x double]]]** %o, align 8
	  %99 = load i32, i32* %g, align 4
	  %97 = load i32, i32* %f, align 4
	  %95 = load i32, i32* %e, align 4
	  %93 = load double, double* %i, align 8
	  ...
	  store double %106, double* %117, align 8
	  %119 = call double @sqrt(double 5.000000e-01) #4
	  ...
	  %122 = load double, double* %l, align 8
