	...
	store  i32 %10, i32* %d, align 8
	  ...
	  store float 0x3FC99999A0000000, float* %g, align 4
	  store float 5.000000e-01, float* %j, align 4
	  store float 0xBFE99999A0000000, float* %m, align 4
	  store float 0xBFD3333340000000, float* %h, align 4
	  store float 0x3FE3333340000000, float* %k, align 4
	  store float 0xBFECCCCCC0000000, float* %n, align 4
	  store float 0x3FD99999A0000000, float* %i, align 4
	  store float 0x3FE6666660000000, float* %l, align 4
	  store float 0x3FB99999A0000000, float* %o, align 4
	  %7 = sub nsw i32 %6, 1
	  %8 = icmp slt i32 %5, %7
