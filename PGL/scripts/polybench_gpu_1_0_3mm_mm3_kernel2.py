...
def polybench_gpu_1_0_3mm_mm3_kernel2():
	...
	NXG.add_edge(145, 12, weight=1)
	NXG.add_edge(146, 14, weight=1)
	NXG.add_edge(147, 16, weight=1)
	NXG.add_edge(148, 18, weight=1)
	NXG.add_edge(149, 10, weight=1)
	NXG.add_edge(150, 20, weight=1)
	NXG.add_edge(151, 70, weight=1)
	NXG.add_edge(151, 93, weight=1)
	NXG.add_edge(151, 119, weight=1)
