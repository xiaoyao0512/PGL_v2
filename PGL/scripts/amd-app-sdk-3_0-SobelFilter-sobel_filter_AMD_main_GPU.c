...
int i;
const int LIST_SIZE = 2097152;
char4* a = (char4*) malloc(sizeof(char4) * LIST_SIZE);
for (int aaa = 0; aaa < LIST_SIZE; aaa++) {
	a[aaa] = (char4) ( 5, 5, 5, 5);
}

char4* b = (char4*) malloc(sizeof(char4) * LIST_SIZE);
...
fp = fopen("amd-app-sdk-3.0-SobelFilter-sobel_filter.cl", "r");
if (!fp) {
...
cl_mem a_mem_obj = clCreateBuffer(context, CL_MEM_READ_WRITE,
	LIST_SIZE * sizeof(char4), NULL, &ret);
cl_mem b_mem_obj = clCreateBuffer(context, CL_MEM_READ_ONLY,
	LIST_SIZE * sizeof(char4), NULL, &ret);
ret = clEnqueueWriteBuffer(command_queue, a_mem_obj, CL_TRUE, 0,
	LIST_SIZE * sizeof(char4), a, 0, NULL, NULL);
ret = clEnqueueWriteBuffer(command_queue, b_mem_obj, CL_TRUE, 0,
	LIST_SIZE * sizeof(char4), b, 0, NULL, NULL);
