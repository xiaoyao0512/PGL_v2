...
char* d = (char*) malloc(sizeof(char) * LIST_SIZE);
for (int ddd = 0; ddd < LIST_SIZE; ddd++) {
	d[ddd] = 5;
}

char* e = (char*) malloc(sizeof(char) * LIST_SIZE);
for (int eee = 0; eee < LIST_SIZE; eee++) {
	e[eee] = 5;
}

char* f = (char*) malloc(sizeof(char) * LIST_SIZE);
...
fp = fopen("rodinia-3.1-bfs-BFS_1.cl", "r");
if (!fp) {
