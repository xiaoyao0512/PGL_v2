...
import dgl
def polybench_gpu_1_0_3mm_mm3_kernel3():
	NXG = nx.DiGraph()
	NXG.add_node(0, w=1)
	NXG.add_node(1, w=1)
	NXG.add_node(2, w=1)
	...
	NXG.add_edge(145, 10, weight=1)
	NXG.add_edge(146, 12, weight=1)
	NXG.add_edge(147, 14, weight=1)
	NXG.add_edge(148, 20, weight=1)
	NXG.add_edge(149, 16, weight=1)
	NXG.add_edge(150, 18, weight=1)
	NXG.add_edge(151, 1, weight=1)
	NXG.add_edge(151, 2, weight=1)
	NXG.add_edge(151, 3, weight=1)
	NXG.add_edge(151, 4, weight=1)
	NXG.add_edge(151, 5, weight=1)
	NXG.add_edge(151, 6, weight=1)
	NXG.add_edge(151, 7, weight=1)
	NXG.add_edge(151, 8, weight=1)
	NXG.add_edge(151, 9, weight=1)
	NXG.add_edge(151, 137, weight=1)
	NXG.add_edge(152, 22, weight=1)
	NXG.add_edge(152, 24, weight=1)
	NXG.add_edge(152, 44, weight=1)
	NXG.add_edge(153, 70, weight=1)
	NXG.add_edge(153, 93, weight=1)
	NXG.add_edge(153, 119, weight=1)
